...
The documented limitations in [`security.md`](security.md) are not themselves vulnerabilities, but an implementation that claims or enforces behavior differently from that document may be.
